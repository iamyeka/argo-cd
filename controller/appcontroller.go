	...
	for i := range managedResources {
		...
		if live == nil {
			...
			if err != nil {
				...
				ctrl.metricsServer.SetResourceTreeWaitingTime(a,a.ClusterName, waitingTime.Nanoseconds())
				ctrl.metricsServer.SetResourceTreeRunningTime(a, a.ClusterName, runningTime.Nanoseconds())
			}
		}
	}
